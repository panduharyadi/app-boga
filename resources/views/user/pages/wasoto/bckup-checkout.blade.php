...
<div class="row">
        ...
        <div class="row">
          <div class="col-50">
            ...
            @foreach ($alamat as $a)
              ...
              <input type="text" id="adr" name="address" placeholder="542 W. 15th Street" value="{{ $a->alamat }}">
  ...
  <div class="col-25">
    <div class="container">
      @foreach ($menu as $m)
        <h4>Cart </h4>
        <p><a href="#" style="text-decoration: none; color: black;">{{ $m->menu_name }}</a> <span class="price">Rp. {{ $m->price }}</span></p> 
      @endforeach
      <hr>
